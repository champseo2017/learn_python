...
"""
"""
จงเขียนโปรแกรมคำนวณภาษีที่ต้องจ่ายโดยมีอัตราภาษีเท่ากับ 7% กำหนดให้ตัวแปรภาษีเป็นค่าคงที่และให้ผู้ใช้งานป้อนข้อมูลผ่านทาง
คีย์บอร์ด
"""
"""
vat = 7
...
while True:
  try:
      print("โปรแกรมคำนวณภาษีที่ต้องจ่าย อัตรภาษีเท่ากับ 7%")
      num = int(input("กรุณาป้อนตัวเลขของคุณ : "))
  except ValueError:
    ...
    clu = (vat * num) / divide
    print("อันตรา Vat 7% ของคุณเท่ากับ = ", clu, "บาท")
    break
"""

"""
จงเขียนโปรแกรมคำนวณอายุ พศ ปัจจุบันลบปีเกิด
"""
"""
era = "2561"
Buddhist = int(era)
while True:
  try:
      print("โปรแกรมคำนวณอายุ ปี พ.ศ ที่เกิดลบ ปีปัจจุบัน")
      num_age = int(input("กรุณาป้อนปี พ.ศ ที่เกิดของคุณ : "))
  except ValueError:
     print("กรุณากรอกตัวเลข")
     continue
  else:
    clu_age = Buddhist - num_age
    print("คุณมีอายุ = ", clu_age, "ปี")
    break
"""

"""
oct คือ แปลงเลขฐานสิบเป็นฐานแปด
hex คือ แปลงเลขฐานสิบเป็นฐานสิบหก
ิbin คือ แปลงเลขฐานสิบเป็นฐานสอง
"""
"""
x = 456
print("แปลงเลขฐานสิบเป็นฐานแปด oct: ", oct(x))
print("แปลงเลขฐานสิบเป็นฐานสิบหก hex: ", hex(x))
print("แปลงเลขฐานสิบเป็นฐานสอง bin: ", bin(x))
"""
